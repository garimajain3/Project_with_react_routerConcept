...
//  here Link is used for a tag because react never refresh page (a tag se poora page reload hota h ) , link m href ki jagh to use karte h
// Nav link will be used for 
